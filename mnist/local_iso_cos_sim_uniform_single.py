...
if __name__ == '__main__':
    ...
    parser.add_argument('--path_dir', default='experiment/LocalIsoCosSimUniformSingle/', type=str)
    ...
    parser.add_argument('--checkpoint_path', default="experiment/LocalqIsoCosSimUniformSingle/800.pth", type=str)
