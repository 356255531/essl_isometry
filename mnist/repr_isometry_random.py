...
def rotate_images(images):
    ...
    rotated_images = [FF.rotate(base_images, interpolation=FF.InterpolationMode.BILINEAR, expand=False, fill=fill) for angle in rotated_angles]
...
def iso_loss_func(z_rotated, rotated_angles):
    ...
    loss = F.mse_loss(torch.matmul(W, z_rotated), z_rotated)
    return loss
